...
class SimulationReport():
    def __init__(self,latency=None,theory_mac=None,theory_mem_access=None,compute_latency=None,memory_latency=None,cfg=None) -> None:
        """
    ...
    def __add__(self,other):
        ...
        for att in ['latency','compute_latency','memory_latency','theory_mac','theory_mem_access']:
    ...
    def __str__(self):
        ...
        for att in ['compute_latency','memory_latency','theory_mac','theory_mem_access']:
