_base_ = [
    '../_base_/datasets/coco_detection_8x2.py', '../_base_/default_runtime.py'
]
model = dict(
    type='DDQDETR',
    ...
    backbone=dict(
        ...
        init_cfg=dict(type='Pretrained', checkpoint='checkpoints/imagenet_pretrain/r101_channel_2222_0x5.pth.tar'),
        sparsity_target=0.5),
    neck=dict(
        type='ChannelMapper',
