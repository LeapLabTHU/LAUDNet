...
class MaskFormer(SingleStageDetector):
    ...
    def loss(self, batch_inputs: Tensor,
        ...
        img_feats, additional, model_configs = self.extract_feat(batch_inputs)

        losses = self.panoptic_head.loss(img_feats, batch_data_samples)
    ...
    def predict(self,
        ...
        feats, additional, model_configs = self.extract_feat(batch_inputs)
